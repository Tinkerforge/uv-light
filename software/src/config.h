 ...
 *
 * config.h: UV Light Bricklet specific configuration
 *
...
#define BRICKLET_DEVICE_IDENTIFIER 265

#define BOARD_MCK 64000000

#define PIN_ACK (BS->pin1_ad)
...
typedef struct {
	...
	uint32_t last_value[NUM_SIMPLE_VALUES];
	...
	uint32_t  threshold_min[NUM_SIMPLE_VALUES];
	uint32_t  threshold_max[NUM_SIMPLE_VALUES];
	char     threshold_option[NUM_SIMPLE_VALUES];

	uint32_t  threshold_min_save[NUM_SIMPLE_VALUES];
	uint32_t  threshold_max_save[NUM_SIMPLE_VALUES];
